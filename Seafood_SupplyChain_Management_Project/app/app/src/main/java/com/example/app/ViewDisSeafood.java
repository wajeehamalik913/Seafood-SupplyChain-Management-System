...
public class ViewDisSeafood extends AppCompatActivity {
...
//Extract the data…
        Query query =fStore.collection("Seafood").whereEqualTo("status","dis").whereEqualTo("user_Id",userId);
        ...
        adapter.setOnItemClickListener(new OrderAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Toast.makeText(ViewDisSeafood.this,"Position: "+position+"ID:"+id ,Toast.LENGTH_SHORT).show();
