                ...
                fAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>(){
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task){
                        if(task.isSuccessful()){
                            Toast.makeText(AddDistributor.this,"User Created",Toast.LENGTH_SHORT).show();
                            ...
                            documentReference.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    Log.d(TAG,"onSuccess: Distributor profile created for"+userId);
                                }
                            });
                            startActivity(new Intent(getApplicationContext(),Restaurant.class));
                        }
                        else{
                            Toast.makeText(AddDistributor.this,"Error"+ task.getException().getMessage() ,Toast.LENGTH_SHORT).show();
